...
namespace Zh_YROEIM_NET_API.Models;

public partial class ContextTextbook : DbContext
{
    public ContextTextbook()
    {
    }

    public ContextTextbook(DbContextOptions<ContextTextbook> options)
        : base(options)
    {
    }
